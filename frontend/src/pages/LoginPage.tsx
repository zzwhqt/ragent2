...
export function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center px-4">
      <div className="absolute inset-0 bg-gradient-to-br from-slate-50 via-orange-50/50 to-orange-100 dark:from-slate-950 dark:via-slate-900 dark:to-slate-900" />
